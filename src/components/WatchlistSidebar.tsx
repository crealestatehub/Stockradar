...
export default function WatchlistSidebar() {
  ...
  return (
    <aside className={`flex flex-col transition-all duration-300 ${sidebarOpen ? 'w-48' : 'w-10'} border-r border-[var(--border)] bg-[var(--bg-elevated)] flex-shrink-0 overflow-hidden`}>
      <div className="flex items-center justify-between px-2 py-3 border-b border-[var(--border)]">
        ...
        <button
          ...
          className="text-[var(--text-dim)] hover:text-[var(--text)] transition-colors ml-auto flex-shrink-0"
        >
